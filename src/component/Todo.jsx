...
function Todo() {
    ...
    const { alltodo, todo_loader , delTodo } = useTodo()
    ...
    return (
        <div className='text-white w-[90%] mx-auto rounded-xl h-[315px] mt-10 overflow-y-auto scrollbar-hide '>

            {
                todo_loader ? (
                    <div className='w-full h-full flex gap-5 flex-col justify-center items-center'>
                        ...
                        <p className='tracking-[4px] text-xl'>Loading...</p>
                    </div>
                ) :
